...
const hrefs = [
    "https://www.hanwhalife.com/main/MN_0000000_P10000.do",
    "https://www.samsunglife.com/",
    "https://www.metlife.co.kr/",
];
const cancerKeywords = [
    ["간암", "갑상선암", "폐암", "위암"],
    ["위암", "대장암"],
